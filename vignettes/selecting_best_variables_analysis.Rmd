...
## Part A) Target Profiling with Histograms: `plotar`(`histdens`)
...
```
_Dashed-line represents the mean._
...
_Probably this is an incomplete concept, but based on an visual analysis this is what an statistical test sees. For example: calculating how much differs these shapes: measuring the differences between the mean -and other metrics- among the groups..._


## Part B) Target Profiling with Boxplots: `plotar`(`boxplot`)
```{r variable_importance2, results="hide", fig.height=4, fig.width=8}
...
```{r variable_importance_c1, results="hide", fig.height=4, fig.width=8}
...
```{r variable_importance_c2, results="hide", fig.height=4, fig.width=12}
...
```{r variable_importance_c4, results="hide", fig.height=4, fig.width=8}
...
```{r variable_importance_c5, results="hide", fig.height=4, fig.width=12}
...
```{r variable_importance_c6, results="hide", fig.height=4, fig.width=10}
