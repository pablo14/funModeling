...
############################################################################################
## 1 var, stop ##############################################
data_prep_a=prep_outliers(data = heart_disease, str_input = c('age','resting_blood_pressure'),
...
data_prep_h2=funModeling::prep_outliers(data = data_prep_h, str_input = c('age','resting_blood_pressure'), method = "hampel",  type='stop')
